export const Header = () => {
  ...
  return (
    <header className="container sticky py-4 flex items-center justify-between">
      ...
      <ul className="hidden lg:flex gap-2 items-center justify-between">
        <li className=" flex p-2 rounded-xl border border-MainColor  hover:border-AccentColor  focus:border-AccentColor duration-300 ease-in-out group cursor-pointer">
          <a href="">
            <svg
        ...
        <li className=" flex p-2 rounded-xl border border-MainColor  hover:border-AccentGreenColor  focus:border-AccentGreenColor duration-300 ease-in-out group cursor-pointer">
          <a href="">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="36"
